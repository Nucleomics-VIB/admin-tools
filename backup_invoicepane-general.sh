...
# compress and archive invoiceplane-general to L:
...
servername="invoiceplane-general"
...
serverpath=/var/lib/invoiceplane-1.5.4-nucleomics
...
password="mysql4IP"
host="localhost"
db_name="nucleomics_invoiceplane"
