...
# compress and archive wikilix to L:
# Stephane Plaisance - VIB-NC Jan-26-2018 v1.0
# added to /etc/cron.d/web_backups-cron
# added serverfolder to account for future upgrades
serverfolder="mediawiki-1.30.0"
servername="wikilix"
...
serverpath=/var/lib/${serverfolder}
